  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-primary text-primary-foreground hover:shadow-luxe hover:-translate-y-0.5 shadow-soft",
        gold: "bg-gold text-foreground hover:bg-gold/90 shadow-soft hover:-translate-y-0.5",
        outlineGold: "border border-gold/40 text-foreground hover:bg-gold-soft hover:border-gold",
        heroGold: "gradient-gold text-foreground hover:shadow-glow-gold hover:-translate-y-0.5 shadow-soft",
      },
      size: {
